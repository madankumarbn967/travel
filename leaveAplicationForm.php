...
<?php 
  ...
  if(isset($_POST['submit'])){
    ...
    if($leaveApplicationValidate){
      ...
      if($execute){
        echo '<script>alert("Travel Application Submitted. Please wait for approval status!")</script>';
      }
      else{
...
<head>
  ...
  <style>
    ...
    body{
        background-color:  rgba(245, 209, 6, 0.39);
       }
...
<body>
  ...
  <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Online Travel request and approval system</a>
      <ul class="nav justify-content-end">
           
            <li class="nav-item">
                <a class="nav-link" href="myhistory.php" style="color:white;">My travel History</a>
            </li>
            <li class="nav-item">
  ...
  <div class="container">
    ...
    <form method="POST">
      ...
      <label><b>Select Travel Type :</b></label>
      <!-- error message if type of absence isn't selected -->
      <span class="error"><?php echo "&nbsp;".$absenceErr ?></span><br/>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Medical treatment" id="Medical treatment">
        <label class="form-check-label" for="Medical treatment">
        Medical treatment
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Hackthon" id="Hackthon">
        <label class="form-check-label" for="Hackthon">
        Hackthon
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Education trip" id="Education trip">
        <label class="form-check-label" for="Education trip">
        Education trip
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Sports" id="Sports">
        <label class="form-check-label" for="Sports">
        Sports
        </label>
      </div>
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Cultural activities" id="Cultural activities">
        <label class="form-check-label" for="Cultural activities">
        Cultural activities
        </label>
      </div>
      <div class="form-check">
      ...
      <div class="form-check">
        <input class="form-check-input" name="absence[]" type="checkbox" value="Job Interviews" id="Job Interviews">
        <label class="form-check-label" for="Job Interviews">
        Job Interviews
        </label>
      </div>
      <div class="form-check">
      ...
      <div class="mb-3">
        ...
        <label for="leaveDesc" class="form-label"><b>Please mention time and reasons of your travel :</b></label>
      ...
      <input type="submit" name="submit" value="Submit Travel Request" class="btn btn-success">
    </form>
  ...
  <footer class="footer navbar navbar-expand-lg navbar-light bg-light" style="color:white;">
    <div>
    <p class="text-center">&copy; <?php echo date("Y"); ?> - Online Travel request and response system</p>
      <p class="text-center">Developed By madan kumar and likith gowda</p>
    </div>
  </footer>
