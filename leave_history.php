...
<body>
    <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="admin.php">Online Travel request and approval system</a>
            ...
            <li class="nav-item">
            <a class="nav-link" href="list_emp.php" style="color:white;">View users <span class="badge badge-pill" style="background-color:#2196f3;"><?php include('count_emp.php');?></span></a>
            </li>
            
            <li class="nav-item">
                <a class="nav-link" href="leave_history.php" style="color:white;">View Travel History</a>
            </li>
            <li class="nav-item">
            <button id="logout" onclick="window.location.href='logout.php';">Logout</button> </div>
            </li>
    ...
    <h1>Admin Panel - users Travel History</h1>
                          ...
                          if($leaves){
                            ...
                            if($numrow!=0){
                             ...
                             $cnt++; }
                              ...
                              echo"<tr class='text-center'><td colspan='12'>YOU DON'T HAVE ANY Travel HISTORY! PLEASE APPLY TO VIEW YOUR STATUS HERE!</td></tr>";
                            }
                          }
                          else{
