...
<head>
    ...
    <title>Online Travel request and approval system</title>
    <style>
        #invalidMsg{
            display:none;
        }
...
<body>
    ...
    <div class="content2">
        <p class="heading lead text-start">
            Simple yet effective software for travel  request and approval system
        </p>
        <p class="text-start">
            Every organization may have different needs, so while picking on a Travel management software, it will be
            smart to choose a leave solution that provides the basic requirements while offering the flexibility to
            customize the Travel process. With great managing  Travel is effortless with an all-rounded Travel
            management software.
        </p>
    </div>
    ...
    <div>
      <p class="text-center">&copy; <?php echo date("Y"); ?> - Online Travel request and approval system</p>
