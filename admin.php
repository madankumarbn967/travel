...
<body>
    <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <li class="nav-item">
                <a class="nav-link" href="list_emp.php" style="color:white;">View details <span class="badge badge-pill" style="background-color:#2196f3;"><?php include('count_emp.php');?></span></a>
            </li>
            <li class="nav-item">
    ...
    <div>
    <p class="text-center">&copy; <?php echo date("Y"); ?> - Online travel requeat and approval Application</p>
